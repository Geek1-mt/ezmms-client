    ...
    <div id="addgoods">
        ...
        <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
            ...
            <el-form-item label="商品图片" style="width:500px">
                <el-upload list-type="picture-card" :on-preview="handlePictureCardPreview" :on-change="handleChange"
                    :auto-upload="false" :multiple="false" limit:1 action="http://localhost:3000">
            ...
            <el-form-item label="商品价格*100(￥)" prop="price" style="width:250px">
            ...
            <el-form-item>
                <el-button type="primary" @click="submitForm('ruleForm')">上架商品</el-button>
                <el-button @click="resetForm('ruleForm')">重置列表</el-button>
            </el-form-item>
        </el-form>
    </div>
</template>
...
import { getAllgoods, addGoods } from '../../../api';
    ...
    data() {
        return {
            ...
            rules: {
                ...
                category: [
                    { required: true, message: '请选择商品类别码', trigger: 'blur' }
                ],
                sales_tip: [
