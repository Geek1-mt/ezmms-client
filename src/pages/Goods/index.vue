  ...
  <div id="container" v-if="goodsDetail[0]">
    <div class="pro_detail">
      ...
      <div class="pro_meg">
        ...
        <div class="pro_meg_price">
          <dl>
            ...
            <dd>
              <div class="promo_price">
                <span class="tm-price">{{ goodsDetail[0].price / 100 + '￥' }}</span>
                <b>优惠促销中</b>
              </div>
            </dd>
          </dl>
          <dl>
            <dt>市场价</dt>
            <dd class="nor_price">{{ goodsDetail[0].normal_price / 100 + '￥' }}</dd>
          </dl>
          <dl>
            <dt>本店优惠</dt>
            <dd>包邮</dd>
        ...
        <div class="pro_meg_console">
          <dl class="tb-sku">
            ...
            <dd>
              ...
              <span>剩余库存：</span><em style="font-weight:bold">{{ goodsDetail[0].counts }}&nbsp;</em><span>件</span>
            </dd>
          </dl>
    ...
    <div class="pro_comment">
      ...
      <div v-if="goodsDetail[0].comments_count">
        <div class="media" v-for="(comment, index) in comment" :key="index">
          <div class="media-body">
            ...
            <span>评价:</span>&nbsp;{{ comment.comment_detail }}&nbsp;
            <span>星级分数：</span>
    ...
    <div class="pro_judge" v-if="userInfo.user_name">
      ...
      <el-input type="textarea" autosize placeholder="请输入您的宝贵评价" v-model="textarea">
      </el-input>
      <el-button type="primary" @click="post()">点击发表<i class="el-icon-edit el-icon--right"></i></el-button>
    </div>
    <div class="pro_judge" v-else>
      <h3>评价该商品</h3>
      <span class="judge_erro_tip">登录后才能发表评论</span>
    </div>
  </div>
</template>
...
export default {
  ...
  computed: {
    ...mapState(['goodsDetail', 'userInfo', 'comment'])
  },
  created() {
