<template>
    <div class="user-detail">
        ...
        <div class="user-detail-group">
            ...
            <div class="user-item">
                <span>昵称</span>
                <el-input type="text" placeholder="请输入内容" v-model="user_nickname" maxlength="15" show-word-limit
            ...
            <div class="user-item">
                <span>地址</span>
                <el-input type="text" placeholder="请输入内容" v-model="user_address" maxlength="25" show-word-limit
                    clearable style="width:300px">
                </el-input>
            </div>
            <div class="user-item">
                <span>生日</span>
                <el-date-picker v-model="user_birthday" type="date" placeholder="选择日期" value-format="yyyy-MM-dd">
                </el-date-picker>
            </div>
            <div class="user-item">
                <span>个性签名</span>
                <el-input type="text" placeholder="请输入内容" v-model="user_sign" maxlength="15" show-word-limit clearable
                    style="width:220px">
                </el-input>
            </div>

            <el-button type="danger" @click="saveUserInfo()">提交更新</el-button>
        </div>
    </div>
</template>
...
export default {
    ...
    methods: {
        beforeAvatarUpload(file) {
            ...
            if (!isJPG) {
                this.$message.error('请上传格式为 JPG 或 PNG 的图片!');
            }
            if (!isLt2M) {
                this.$message.error('上传头像图片大小不可超过 1MB!');
            }
            return isJPG && isLt2M;
        },
