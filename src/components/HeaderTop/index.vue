    ...
    <div class="header_nav">
        <div>
            ...
            <div class="locationWrapper">
                ...
                <el-cascader :options="options" :props="{ expandTrigger: 'hover' }" :show-all-levels="false"
                    v-model="selectedOptions" @change="handleAreaChange" :separator="' '" />
            </div>
        </div>
        <ul>
            <li v-if="userInfo.id">
...
export default {
    data() {
        return {
            selectedOptions: [], //用户选择的城市
            options: options,     //储存城市数据
            city: '',  // 定位的城市数据
        }
    },
    mounted() {
